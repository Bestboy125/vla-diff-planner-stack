...
class Settings:
    ...
    observation_mode: str = os.environ.get("VLA_OBSERVATION_MODE", "calibrated")
    observation_max_age_ms: int = int(os.environ.get("OBSERVATION_MAX_AGE_MS", "750"))
    observation_max_future_skew_ms: int = int(
        os.environ.get("OBSERVATION_MAX_FUTURE_SKEW_MS", "300")
    )
    ...
    expected_camera_frame: str = os.environ.get("EXPECTED_CAMERA_FRAME", "vla_usb_camera_optical_frame")
